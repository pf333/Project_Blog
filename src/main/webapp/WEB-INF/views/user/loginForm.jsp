...
<div class="container">
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=99606a0f39977ece1d08e4d759e1a794&redirect_uri=http://localhost:8000/auth/kakao/callback&response_type=code"><img
			src="/image/kakao_login_button.png" / height="38"></a>
	</form>
</div>
